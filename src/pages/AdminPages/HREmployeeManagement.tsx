    ...
    <AdminHeader>
      <div className="p-6">
        ...
        <p className="pt-2 text-sm md:text-base">
          Manage employee accounts and onboarding progress
        </p>

        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 pt-6 md:pt-12 px-4 md:px-6">
          {error && (
            <div className="col-span-full mb-4 p-3 bg-red-50 border border-red-200 rounded-lg">
          ...
          <div className="flex items-center gap-3 md:gap-4 w-full rounded-xl md:rounded-2xl border border-gray-200 bg-white p-3 md:p-4 shadow-sm">
            <FileUser size={32} className="text-gray-800 md:w-10 md:h-10" />
        ...
        <div className="flex justify-center items-center gap-4 mt-6 md:mt-12 px-4 md:px-0">
          <Card className="rounded-xl md:rounded-2xl shadow-lg max-w-7xl w-full p-4 md:p-6">
            {/* Header */}
            <CardHeader className="flex-col sm:flex-row items-start sm:items-center justify-between pb-4 gap-3">
              ...
              <CardAction>
                <Button
                  ...
                  className="rounded-lg bg-violet-600 px-3 md:px-4 py-1.5 md:py-2 text-xs md:text-sm font-medium text-white hover:bg-violet-700 w-full sm:w-auto"
                >
                  + Add Employee
                </Button>
              </CardAction>
            ...
            <CardContent>
              <div className="overflow-x-auto rounded-xl border">
                <table className="w-full border-collapse text-left min-w-[500px]">
                  <thead>
                    <tr className="bg-slate-100 text-xs md:text-sm text-slate-600">
                      <th className="p-3 md:p-6">EMPLOYEE</th>
