// components/modals/content/HRPoliciesContent.tsx
...
const tasks: Task[] = [
  ...
  },
  {
    ...
    status: 'pending',
    description: 'Enroll in company benefits and insurance programs',
    dueDate: 'February 10, 2024',
    steps: [
      'Review benefits package',
      'Select health insurance plan',
      'Choose retirement options',
      'Add beneficiaries',
  ...
  },
  {
    ...
    status: 'pending',
    description: 'Introduction to performance review process and goals',
    dueDate: 'February 15, 2024',
    steps: [
      'Understand review cycle',
      'Set performance goals',
      'Learn evaluation criteria',
      'Schedule first review',
      'Access performance portal',
    ],
  },
];

export function HRPoliciesContent() {
