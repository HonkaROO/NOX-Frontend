// components/modals/content/ITSetupContent.tsx
...
const tasks: Task[] = [
  {
    ...
    status: 'completed',
    description: 'Receive and setup your work equipment',
    dueDate: 'January 15, 2024',
    steps: [
      'Receive laptop and accessories',
      'Sign equipment agreement',
      'Complete inventory checklist',
      'Report any issues',
      'Confirm receipt with IT',
    ],
    documents: [
      { name: 'Equipment Checklist', downloadUrl: '#' },
      { name: 'IT Policy Agreement', downloadUrl: '#' },
    ],
  },
  {
    id: 'accounts',
    name: 'System Accounts Setup',
    status: 'in-progress',
    description: 'Create accounts for all necessary systems and applications',
...
export function ITSetupContent() {
