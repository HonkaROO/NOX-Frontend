// components/modals/content/GovernmentFormsContent.tsx
...
const tasks: Task[] = [
  {
    ...
    status: 'completed',
    description: 'Register for Social Security System benefits and contributions',
    dueDate: 'January 20, 2024',
    steps: [
      'Visit SSS website or nearest branch',
      'Fill out SSS Form E-1',
      'Submit required documents',
      'Get your SSS number',
      'Submit SSS number to HR',
    ],
    documents: [
      { name: 'SSS Form E-1', downloadUrl: '#' },
      { name: 'Birth Certificate', downloadUrl: '#' },
      { name: 'Valid ID', downloadUrl: '#' },
    ],
  },
  {
    id: 'philhealth',
    ...
    steps: [
      'Download PhilHealth Form 1',
      'Fill out personal information',
      'Submit to PhilHealth office',
      'Pay initial premium',
      'Receive PhilHealth ID',
    ],
    documents: [
      { name: 'PhilHealth Form 1', downloadUrl: '#' },
      { name: 'Birth Certificate', downloadUrl: '#' },
      { name: 'Valid ID', downloadUrl: '#' },
    ],
  },
  {
    id: 'pagibig',
    name: 'Pag-IBIG Registration',
    status: 'pending',
    description: 'Register for housing fund and savings program',
    dueDate: 'January 30, 2024',
    steps: [
      'Get Pag-IBIG membership form',
    ...
    documents: [
      { name: 'Pag-IBIG Form', downloadUrl: '#' },
      { name: 'Birth Certificate', downloadUrl: '#' },
      { name: 'Valid ID', downloadUrl: '#' },
    ],
  },
  {
    ...
    status: 'pending',
    description: 'Register for Tax Identification Number with BIR',
    dueDate: 'February 5, 2024',
    steps: [
      'Fill out BIR Form 1901',
      'Submit to BIR office',
      'Pay registration fee',
      'Receive TIN card',
      'Submit TIN to payroll',
    ],
    documents: [
      { name: 'BIR Form 1901', downloadUrl: '#' },
      { name: 'Birth Certificate', downloadUrl: '#' },
      { name: 'Valid ID', downloadUrl: '#' },
    ],
  },
...
export function GovernmentFormsContent() {
